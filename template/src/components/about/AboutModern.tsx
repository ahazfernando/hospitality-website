                ...
                <div className="container mx-auto px-4 py-20 relative z-10">
                    <div className="grid grid-cols-12">
                        <div className="col-span-12 text-center mb-8">
                            ...
                            <h1 className="text-6xl md:text-8xl font-black text-transparent bg-gradient-to-r from-slate-900 via-stone-800 to-neutral-900 bg-clip-text">
                                About The
                        ...
                        <div className="col-span-12 lg:col-span-8 lg:col-start-3">
                            <p className="text-xl text-stone-600 mx-auto leading-relaxed text-center">
            ...
            <div className="container mx-auto px-4 pb-20 relative z-10">
                <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-12 text-center mb-16">
                        ...
                        <div className="col-span-12 lg:col-span-8 lg:col-start-3">
                            <p className="text-lg text-stone-600 mx-auto">
